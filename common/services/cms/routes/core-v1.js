...
router.param('email',function( req, res, next, email){
	if( !email){
  	...
  	if( !( email.endsWith('@wiziq.com')	|| email.endsWith('@gmail.com') 
		  								|| email.endsWith('@facebook.com') || email.endsWith('@authorgen.com')) ){
...
/*
 *  _polyfill for endswith, in case it is not there 
 */
